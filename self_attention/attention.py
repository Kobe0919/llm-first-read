...
Therefore, it is beneficial to use different projections
...
W_q = torch.nn.Parameter(torch.rand(d_in, d_out))  # nn.Parameter makes it learnable
...
query_2 = x_2 @ W_q
# print(query_2)  # DEBUG: temporary output to verify the query vector
...
d_k = keys.shape[1]
attn_weights_2 = torch.softmax(attn_scores_2 / d_k**0.5, dim= 0)  # Scale dot-product attention